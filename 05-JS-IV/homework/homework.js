...
function verificarPassword (usuario, password) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  // también podría ser usuario.password
...
function agregarAmigo (usuario, nuevoAmigo) {
  ...
  // Tu código:
  //también serviría --> usuario.amigos.push(nuevoAmigo);
...
function pasarUsuarioAPremium (usuarios) {
  ...
  //                 i = 0         i = 1        i = 2
  // usuarios.length sería igual a 3 en este caso
